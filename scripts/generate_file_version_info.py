...
FILE_DESCRIPTION = (
    "PyRefactor - A Python refactoring and optimization linter for Windows"
)
LEGAL_COPYRIGHT = (
  ...
  kids=[
    StringFileInfo([
      StringTable(
        ...
        StringStruct(u'InternalName', u'PyRefactor'),
        StringStruct(u'LegalCopyright', u'{LEGAL_COPYRIGHT}'),
        StringStruct(u'OriginalFilename', u'PyRefactor.exe'),
        StringStruct(u'ProductName', u'PyRefactor'),
